const htmlPage = ({ title, description }) => {
  return `<!doctype html>
        <html lang="pt-BR">
          <head>
            <meta charset="UTF-8" />
              ...
              <div class="email-footer">
                ...
                >
                  ...
                  <div style="text-align: left; ">
                    <p
                      style="font-size: 18px; font-weight: bold;color: #321733; margin: 0"
                    >
                      centerlight
                    </p>
                  ...
                  <div style="text-align: right">
                    ...
                    <div style="margin-top: 5px">
                      <a href="https://www.instagram.com/mymingoo/" target="_blank"
                        ><img
                          src="https://centerlight-s3.s3.sa-east-1.amazonaws.com/email/ig-icon.png"
                          alt="Instagram"
                          style="margin-right: 10px; width: 24px; height: 24px; object-fit: cover;"
                      /></a>
                      <a href="https://www.facebook.com/mingoooficial" target="_blank"
                        ><img
                          src="https://centerlight-s3.s3.sa-east-1.amazonaws.com/email/facebook-icon.png"
                          alt="Facebook"
                          style="margin-right: 10px; width: 24px; height: 24px; object-fit: cover;"
                      /></a>
                      <a href="https://www.youtube.com/channel/UC5s2aOnJu1HT62iwEqepj4g" target="_blank"
                        ><img
                          src="https://centerlight-s3.s3.sa-east-1.amazonaws.com/email/yt-icon.png"
                          alt="Twitter"
                          style="margin-right: 10px; width: 24px; height: 24px; object-fit: cover;"
                      /></a>
                    </div>
