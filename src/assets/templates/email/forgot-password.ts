export const emailTemplate = (value: { code: string; url: string }) => {
  return `<!DOCTYPE html
                                                  ...
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                      ...
                                                      <tr>
                                                          <td valign="top"
                                                              ...
                                                              style="padding: 36px 40px 36px 40px;border-radius: 0px;background-color: #1b1b1b;"
                                                              bgcolor="#1b1b1b">
                                                              <table width="100%" border="0" cellpadding="0"
                                                                  ...
                                                                  <tr>
                                                                      <td align="center" valign="top"
                                                                          ...
                                                                          <img src="cid:logo"
                                                                              class="" width="160" height="35" alt=""
                                                                              style="display: block;border: 0;outline: 0;line-height: 100%;-ms-interpolation-mode: bicubic;width:160px;height: auto;max-width: 100%;" />
                                                                      </td>
                                                                  </tr>
                                                              </table>
                                                          </td>
                                                                          ...
                                                                          <table border="0" cellpadding="0"
                                                                              ...
                                                                              <tr>
                                                                                  <td valign="top" class="pc-font-alt"
                                                                                      style="mso-line-height: exactly;line-height: 142%;letter-spacing: -0.4px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 24px;font-weight: bold;color: #151515;">
                                                                                      <div><span>Recuperar
                                                                                              senha</span>
                                                                                      </div>
                                                                                  </td>
                                                                      ...
                                                                      <td style="padding: 12px 0px 0px 0px;">
                                                                          <table
                                                                              ...
                                                                              <tr
                                                                                  ...
                                                                                  <td class="pc-grid-td-first pc-grid-td-last pc-w620-padding-30-0"
                                                                                                                                                                          ...
                                                                                                                                                                          <table
                                                                                                                                                                              ...
                                                                                                                                                                              <tr>
                                                                                                                                                                                  <td valign="top"
                                                                                                                                                                                      class="pc-font-alt"
                                                                                                                                                                                      align="center"
                                                                                                                                                                                      style="mso-line-height: exactly;line-height: 133%;letter-spacing: -0.2px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 18px;font-weight: 500;color: #1b1b1b;text-transform: uppercase;text-align: center;text-align-last: center;">
                                                                                                                                                                                      <div>
                                                                                                      ...
                                                                                                      <tr>
                                                                                                          <td align="left"
                                                                                                              ...
                                                                                                              <table
                                                                                                                  ...
                                                                                                                  <tr>
                                                                                                                      <th valign="top"
                                                                                                                          style="text-align: left;font-weight: normal;line-height: 1;">
                                                                                                                          <!--[if mso]>
      <table  border="0" cellpadding="0" cellspacing="0" role="presentation" align="center" width="520" style="border-collapse: separate;">
          <tr>
              <td valign="middle" align="center" style="text-align: center;color: #ffffff;border-radius: 8px;background-color: #cf4b19;padding: 14px 19px 14px 19px;width: 520px;" bgcolor="#cf4b19">
                                  <a class="pc-font-alt" style="display: inline-block;text-decoration: none;white-space: nowrap;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-weight: 500;font-size: 16px;line-height: 150%;letter-spacing: -0.2px;color: #ffffff;" href="${value.url}" target="_blank">Acessar sessão</a>
                              </td>
          </tr>
      </table>
      <![endif]-->
